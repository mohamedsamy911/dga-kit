...
Primary green references the flag of the Kingdom — DGA states it symbolises "growth, prosperity,
unity, cooperation, and national solidarity." Token family is named `primary-sa-flag`, with
`background-sa-flag` (#074c30) as its surface. Secondary gold signals richness and prestige;
tertiary lavender is a calm accent.
